...
ui <- bs4DashPage(
  ...
  sidebar = bs4DashSidebar(
    ...
    tags$div(
      ...
      tags$h3("Control Panel", class = "menu-title"),
    bs4SidebarMenu(
  ...
  controlbar = bs4DashControlbar(
    ...
    bs4Card(
      ...
      collapsible = TRUE,
      br(),
      actionButton("loadPremiumButton", "Load Premium Data", class = "btn btn-primary btn-primary-custom"),
      br(),
      br(),
      actionButton("loadClaimsButton", "Load Claims Data", class = "btn btn-primary btn-primary-custom"),
      br(),
      br(),
      actionButton("viewExposureButton", "Calculate Exposure Results", class = "btn btn-primary btn-primary-custom"),
      br(),
      br(),
      actionButton("viewClaimsButton", "View Gross Reported Claims", class = "btn btn-primary btn-primary-custom"),
      br(),
      br(),
      actionButton("viewUniqueClaimsButton", "View Unique Claims Summary", class = "btn btn-primary btn-primary-custom"),
      br(),
      br(),
      actionButton("viewClaimFrequenciesButton", "View Claim Frequencies", class = "btn btn-primary btn-primary-custom"),
      br(),
      br(),
      actionButton("viewClaimSeveritiesButton", "Calculate Claim Severities", class = "btn btn-primary btn-primary-custom"),
      br(),
      br(),
      actionButton("viewRiskPremiumButton", "Calculate Risk Premium", class = "btn btn-primary btn-primary-custom"),
      br(),
      br(),
      actionButton("viewOfficePremiumButton", "Calculate Office Premium", class = "btn btn-primary btn-primary-custom"),
      br(),
      br(),
      actionButton("showPlot1", "Frequency vs Severity Plot", class = "btn btn-primary btn-primary-custom"),
    )
  ),
  body = dashboardBody(
    tags$head(
      ...
      bs4TabItem(tabName = "viewPremiumData",
                 fluidRow(
                   ...
                   div(
                     ...
                     fileInput("file1", 
                               label = tags$span("Upload Premium Data as a Excel File", class = "upload-label"),
                               accept = c(".xlsx", ".xls")
                     ),
      ...
      bs4TabItem(tabName = "viewClaimsData",
                 fluidRow(
                   ...
                   div(
                     class = "upload-container",
                     fileInput("file2", 
                               label = tags$span("Upload Claim Data as a Excel File", class = "upload-label"),
                               accept = c(".xlsx", ".xls")
                     ),
                     tags$p(class = "instruction-header", "Data Upload Guidelines:"),
                     tags$ul(
      ...
      bs4TabItem(tabName = "viewExposureResults",
                 fluidRow(
                   bs4Card(
                     ...
                     solidHeader = TRUE,
                     width = 12,
                     downloadButton("downloadExposure", "Download Exposure Results", class = "btn btn-primary btn-primary-custom"),
                     br(),
                     br(),
                     fluidRow(hr(),
      ...
      bs4TabItem(tabName = "viewGrossReportedClaims",
                 fluidRow(
                   bs4Card(
                     ...
                     solidHeader = TRUE,
                     width = 12,
                     downloadButton("downloadGrossClaims", "Download Gross Reported Claims", class = "btn btn-primary btn-primary-custom"),
                     br(),
                     br(),
                     fluidRow(hr(),
      ...
      bs4TabItem(tabName = "viewUniqueClaimsSummary",
                 fluidRow(
                   bs4Card(
                     ...
                     solidHeader = TRUE,
                     width = 12,
                     downloadButton("downloadUniqueClaims", "Download Unique Claims Data", class = "btn btn-primary btn-primary-custom"),
                     br(),
                     br(),
                     fluidRow(hr(),
      ...
      bs4TabItem(tabName = "viewClaimFrequencies",
                 fluidRow(
                   bs4Card(
                     ...
                     solidHeader = TRUE,
                     width = 12,
                     downloadButton("downloadClaimFrequencies", "Download Claim Frequencies Data", class = "btn btn-primary btn-primary-custom"),
                     br(),
                     br(),
                 ...
                 fluidRow(
                   bs4Card(
                     ...
                     solidHeader = TRUE,
                     width = 12,
                     downloadButton("downloadClaimFrequenciesvariance", "Download Claim Frequencies Variance Data", class = "btn btn-primary btn-primary-custom"),
                     br(),
                     br(),
      ...
      bs4TabItem(tabName = "viewClaimSeverities",
                 fluidRow(
                   bs4Card(
                     ...
                     solidHeader = TRUE,
                     width = 12,
                     downloadButton("downloadClaimSeverities", "Download Claim Severities Data", class = "btn btn-primary btn-primary-custom"),
                     br(),
                     br(),
                 ...
                 fluidRow(
                   bs4Card(
                     ...
                     solidHeader = TRUE,
                     width = 12,
                     downloadButton("downloadClaimSeveritiesVariance", "Download Claim Severities variance Data", class = "btn btn-primary btn-primary-custom"),
                     br(),
                     br(),
      ...
      bs4TabItem(tabName = "viewRiskPremium",
                 fluidRow(
                   bs4Card(
                     ...
                     solidHeader = TRUE,
                     width = 12,
                     downloadButton("downloadRiskPremium", "Download Risk Premium Data", class = "btn btn-primary btn-primary-custom"),
                     br(),
                     br(),
      ...
      bs4TabItem(tabName = "viewOfficePremium",
                 fluidRow(
                   bs4Card(
                     ...
                     downloadButton("downloadOfficePremium", "Download Office Premium Data", class = "btn btn-primary btn-primary-custom"),
                     br(),
                     br(),
